...
const SingleList = ({ title }: { title: string }) => {
  return (
    <div className="basis-[31%] bg-[#F8FAE5] border border-gray-200 rounded-xl shadow p-1 ps-3.5 text-gray-700 overflow-hidden cursor-pointer">
      <div className="flex flex-row gap-x-3">
        ...
        <div className="basis-3/5 flex flex-col gap-y-2">
          <div>
          ...
          <div className="tracking-wide mx-2">
            ...
            <p className="text-gray-400 text-[13px]">100 stories</p>
          </div>
        </div>
      </div>
    </div>
